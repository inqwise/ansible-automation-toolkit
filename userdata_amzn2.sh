...
catch_error () {
    ...
    echo "An error occurred in userdata_amzn2: $1"
...
main () {
    ...
    bash main.sh -r $REGION -e "playbook_name=$PLAYBOOK_NAME" --topic-name $TOPIC_NAME --account-id $ACCOUNT_ID
    rm vault_password
    echo "End userdata_amzn2"
}
