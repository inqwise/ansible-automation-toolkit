...
set -euo pipefail
echo "start main_amzn2.sh with toolkit_version: ${TOOLKIT_VERSION}"

# URL for requirements_amzn2023.yml
REQUIREMENTS_YML_URL="https://raw.githubusercontent.com/inqwise/ansible-automation-toolkit/${TOOLKIT_VERSION}/requirements_amzn2.yml"
